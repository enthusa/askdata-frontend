    ...
    el-dialog(:title='formTitle' :visible.sync='formVisible')
      ...
      el-form(:model='datasources.instance' :rules='datasources.rules' ref='modal'  label-width='95px' label-suffix=':')
        ...
        el-form-item(prop='dbHost' label='Host')
          el-input(v-model='datasources.instance.dbHost')
        el-form-item(prop='dbPort' label='Port')
          el-input(v-model='datasources.instance.dbPort')
        el-form-item(prop='dbName' label='Name')
          el-input(v-model='datasources.instance.dbName')
